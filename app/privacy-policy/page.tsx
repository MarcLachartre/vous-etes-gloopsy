export default async function PrivacyPolicy() {
    return (
        <div>
            <h1>Privacy Policy for Vous êtes Gloopsy</h1>
            ...
            <p>
                ...
                vous-etes-gloopsy. This policy is not applicable to any
            ...
            <p>
                vous-etes-gloopsy follows a standard procedure of using log
            ...
            <p>
                Like any other website, vous-etes-gloopsy uses "cookies". These
            ...
            <p>
                ...
                the advertising partners of vous-etes-gloopsy.
            </p>
            ...
            <p>
                ...
                vous-etes-gloopsy, which are sent directly to users' browser.
            ...
            <p>
                Note that vous-etes-gloopsy has no access to or control over
            ...
            <p>
                vous-etes-gloopsy's Privacy Policy does not apply to other
            ...
            <p>
                vous-etes-gloopsy does not knowingly collect any Personal
